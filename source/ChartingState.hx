		...
		try
		{
			...
			if (doInput)
			{
				...
				if (FlxG.keys.pressed.SHIFT || key_shift.pressed)
				{
					if (FlxG.keys.justPressed.RIGHT || FlxG.keys.justPressed.D #if mobileC || _pad.buttonRight.justPressed #end)
						speed += 0.1;
					else if (FlxG.keys.justPressed.LEFT || FlxG.keys.justPressed.A #if mobileC || _pad.buttonLeft.justPressed #end)
						speed -= 0.1;
			...
			if (doInput)
			{
				...
				if (!typingShit.hasFocus)
				{
					...
					if (!FlxG.keys.pressed.SHIFT || !key_shift.pressed)
					{
						if (FlxG.keys.pressed.W || FlxG.keys.pressed.S #if mobileC || _pad.buttonUp.pressed || _pad.buttonDown.pressed #end)
						{
							FlxG.sound.music.pause();
							if (!PlayState.isSM)
								vocals.pause();
					...
					{
						if (FlxG.keys.justPressed.W || FlxG.keys.justPressed.S #if mobileC || _pad.buttonUp.pressed || _pad.buttonDown.pressed #end)
						{
							FlxG.sound.music.pause();
							if (!PlayState.isSM)
								vocals.pause();
