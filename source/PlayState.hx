...
class PlayState extends MusicBeatState
{
	...
	override public function update(elapsed:Float)
	{
		...
		if ((FlxG.keys.anyJustPressed([pauseBind]) #if mobileC #if android || FlxG.android.justReleased.BACK #end || _pad.buttonPause.justPressed #end || KeyBinds.gamepad && FlxG.keys.anyJustPressed([gppauseBind]))
			&& startedCountdown
			&& canPause
			&& !cannotDie)
		{
