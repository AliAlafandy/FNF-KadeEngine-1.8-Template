...
class OptionsMenu extends FlxSubState
{
	...
	override function update(elapsed:Float)
	{
		...
		accept = FlxG.keys.justPressed.ENTER #if mobileC || _pad.buttonA.justPressed #end || (gamepad != null ? gamepad.justPressed.A : false);
		right = FlxG.keys.justPressed.RIGHT #if mobileC || _pad.buttonRight.justPressed #end || (gamepad != null ? gamepad.justPressed.DPAD_RIGHT : false);
		left = FlxG.keys.justPressed.LEFT #if mobileC || _pad.buttonLeft.justPressed #end || (gamepad != null ? gamepad.justPressed.DPAD_LEFT : false);
		up = FlxG.keys.justPressed.UP #if mobileC || _pad.buttonUp.justPressed #end || (gamepad != null ? gamepad.justPressed.DPAD_UP : false);
