...
class AnimationDebug extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.ESCAPE #if mobileC || _pad.buttonB.justPressed #end)
		{
			FlxG.mouse.visible = false;
			FlxG.switchState(new PlayState());
		}

		if (FlxG.keys.justPressed.E #if mobileC || _pad.buttonIn.justPressed #end)
			FlxG.camera.zoom += 0.25;
		if (FlxG.keys.justPressed.Q #if mobileC || _pad.buttonOut.justPressed #end)
			FlxG.camera.zoom -= 0.25;
		...
		if (FlxG.keys.justPressed.W #if mobileC || _pad.buttonUp2.justPressed #end)
		{
			curAnim -= 1;
		}

		if (FlxG.keys.justPressed.S #if mobileC || _pad.buttonDown2.justPressed #end)
		{
			curAnim += 1;
		}
		...
		if (FlxG.keys.justPressed.S || FlxG.keys.justPressed.W || FlxG.keys.justPressed.SPACE #if mobileC || _pad.buttonDown2.justPressed || _pad.buttonUp2.justPressed || _pad.buttonA.justPressed #end)
		{
			char.playAnim(animList[curAnim]);
		...
		if (FlxG.keys.pressed.CONTROL && FlxG.keys.justPressed.S #if mobileC || _pad.buttonSave.justPressed #end)
			saveBoyOffsets();
